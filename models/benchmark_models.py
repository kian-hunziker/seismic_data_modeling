...
class PhaseNetLit(SeisBenchModuleLit):
    ...
    def __init__(self, lr=1e-2, sigma=20, sample_boundaries=(None, None), pretrained=False, pretrain_data='ethz', **kwargs):
        super().__init__()
        ...
        if not pretrained:
            ...
            self.model = sbm.PhaseNet.from_pretrained(pretrain_data)
...
class GPDLit(SeisBenchModuleLit):
    ...
    def __init__(self, lr=1e-3, highpass=None, sigma=None, pretrained=False, pretrain_data='ethz', **kwargs):
        super().__init__()
        self.save_hyperparameters()
        self.lr = lr
        self.sigma = sigma
        if pretrained:
            self.model = sbm.GPD.from_pretrained(pretrain_data)
        else:
...
class EQTransformerLit(SeisBenchModuleLit):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if pretrained:
            self.model = sbm.EQTransformer.from_pretrained(pretrain_data)
        else:
...
class CREDLit(SeisBenchModuleLit):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.loss = torch.nn.BCELoss()
        if pretrained:
            self.model = sbm.CRED.from_pretrained(pretrain_data)
        else:
...
class BasicPhaseAELit(SeisBenchModuleLit):
    ...
    def __init__(self, lr=1e-2, sigma=20, sample_boundaries=(None, None), pretrained=False, pretrain_data='ethz', **kwargs):
        ...
        self.loss = vector_cross_entropy
        if pretrained:
            self.model = sbm.BasicPhaseAE.from_pretrained(pretrain_data)
        else:
...
class DPPDetectorLit(SeisBenchModuleLit):
    ...
    def __init__(self, lr=1e-3, pretrained=False, pretrain_data='ethz', **kwargs):
        super().__init__()
        self.save_hyperparameters()
        self.lr = lr
        self.nllloss = torch.nn.NLLLoss()
        self.loss = self.nll_with_probabilities
        if pretrained:
            self.model = sbm.DPPDetector.from_pretrained(pretrain_data)
        else:
...
class DPPPickerLit(SeisBenchModuleLit):
    ...
    def __init__(self, mode, lr=1e-3, pretrained=False, pretrain_data='ethz', **kwargs):
        super().__init__()
        self.save_hyperparameters()
        self.mode = mode
        self.lr = lr
        self.loss = torch.nn.BCELoss()
        if pretrained:
            self.model = sbm.DPPPicker.from_pretrained(pretrain_data)
        else:
