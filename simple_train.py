...
class SimpleSeqModel(pl.LightningModule):
    def __init__(self, config):
        ...
        try:
            ...
            d_model = 0
        self.encoder = instantiate_encoder_simple(self.hparams.encoder, d_data=3, d_model=d_model)
        self.decoder = instantiate_decoder_simple(self.hparams.decoder, d_data=3, d_model=d_model)
